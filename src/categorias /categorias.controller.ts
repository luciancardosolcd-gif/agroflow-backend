...
export class CategoriasController {
  ...
  @Get('analiticas')
  @ApiOperation({ summary: 'Lista apenas categorias analíticas (selecionáveis em lançamentos)' })
  listarAnaliticas() {
  ...
  @Get(':id')
  @ApiOperation({ summary: 'Busca categoria por ID com breadcrumb' })
  ...
  @Post()
  @Roles('admin', 'gestor')
  @ApiOperation({ summary: 'Cria nova categoria (admin/gestor)' })
